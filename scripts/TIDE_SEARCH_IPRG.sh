...
DATA_FILE_ORIGINAL=/home/attila/msdatasets/iPRG_continuous_scan.ms2
DATA_FILE_PEAK_FILTERED_LR=/home/attila/peak_filter_learning/iprg_lowres_filtered_10_xent.ms2
DATA_FILE_PEAK_FILTERED_HR=/home/attila/peak_filter_learning/iprg_highres_filtered_10_xent.ms2
DATA_FILE_BOLTZMATCH_RAW_LR=/hdd/archive/pavel/boltzmatch/data/lowres/unsuper/IPRG.ms2
DATA_FILE_BOLTZMATCH_TAILOR_LR=/hdd/archive/pavel/boltzmatch/data/lowres/weak/IPRG.ms2 
DATA_FILE_BOLTZMATCH_RAW_HR=/hdd/archive/pavel/boltzmatch/data/highres/unsuper/IPRG.ms2
DATA_FILE_BOLTZMATCH_TAILOR_HR=/hdd/archive/pavel/boltzmatch/data/highres/weak/IPRG.ms2 
INDEX=IPRG_IDX
TAXON=IPRG
...
# PARAM="--exact-p-value T --mz-bin-width 1.0005079"
# OUTPUT_DIR=$PATH$TAXON$FOLDER_POST
# $CRUX_ORIGINAL tide-search $FIX_PARAM $PARAM --output-dir $OUTPUT_DIR $DATA_FILE_BOLTZMATCH_RAW_LR $PATH$INDEX
# $CRUX_ORIGINAL assign-confidence --decoy-prefix DECOY_ --overwrite T --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
# $CRUX_ORIGINAL percolator --overwrite T --feature-file-out T --output-weights T --decoy-prefix DECOY_ --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
...
# PARAM="--exact-p-value F --mz-bin-width 0.05 --use-tailor-calibration T"
# OUTPUT_DIR=$PATH$TAXON$FOLDER_POST
# $CRUX_ORIGINAL tide-search $FIX_PARAM $PARAM --output-dir $OUTPUT_DIR $DATA_FILE_BOLTZMATCH_RAW_HR $PATH$INDEX
# $CRUX_ORIGINAL assign-confidence --decoy-prefix DECOY_ --score "xcorr score" --overwrite T --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
# $CRUX_ORIGINAL assign-confidence --decoy-prefix DECOY_ --score "tailor score" --overwrite T --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
# $CRUX_ORIGINAL percolator --overwrite T --feature-file-out T --output-weights T --decoy-prefix DECOY_ --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
...
$CRUX_ORIGINAL assign-confidence --decoy-prefix decoy_ --overwrite T --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
$CRUX_ORIGINAL percolator --overwrite T --feature-file-out T --output-weights T --decoy-prefix decoy_  --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.incscan.txt

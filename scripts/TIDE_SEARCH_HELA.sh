...
DATA_FILE_ORIGINAL=/hdd/data/HeLa/20150410_QE3_UPLC9_DBJ_SA_46fractions_Rep1_1.mgf
DATA_FILE_PEAK_FILTERED_LR=/home/attila/peak_filter_learning/HeLa_lowres_filtered_10_xent.ms2
DATA_FILE_PEAK_FILTERED_HR=/home/attila/peak_filter_learning/HeLa_highres_filtered_10_xent.ms2
...
# OUTPUT_DIR=$PATH$TAXON$FOLDER_POST
# $CRUX_ORIGINAL tide-search $FIX_PARAM $PARAM --output-dir $OUTPUT_DIR $DATA_FILE_ORIGINAL $PATH$INDEX
# $CRUX_ORIGINAL assign-confidence --overwrite T --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
# $CRUX_ORIGINAL percolator --overwrite T --feature-file-out T --output-weights T --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
...
# OUTPUT_DIR=$PATH$TAXON$FOLDER_POST
# $CRUX_ORIGINAL tide-search $FIX_PARAM $PARAM --output-dir $OUTPUT_DIR $DATA_FILE_BOLTZMATCH_RAW_LR $INDEX
# $CRUX_ORIGINAL assign-confidence --overwrite T --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
...
# OUTPUT_DIR=$PATH$TAXON$FOLDER_POST
# $CRUX_ORIGINAL tide-search $FIX_PARAM $PARAM --output-dir $OUTPUT_DIR $DATA_FILE_BOLTZMATCH_RAW_HR $INDEX
# $CRUX_ORIGINAL assign-confidence --score "xcorr score" --overwrite T --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
# $CRUX_ORIGINAL assign-confidence --score "tailor score" --overwrite T --output-dir $OUTPUT_DIR $OUTPUT_DIR/tide-search.txt
